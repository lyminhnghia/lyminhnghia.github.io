...
<ComponentPreview
  ...
  openInV0Url="https://lyminhnghia.github.io/r/code-block-command.json"
/>
...
```bash
npx shadcn@latest add @lyminhnghia/code-block-command
```
...
- [Copy Button](https://lyminhnghia.github.io/components/copy-button)
...
<CodeBlockCommand
  ...
  yarn="yarn dlx shadcn add @lyminhnghia/code-block-command"
