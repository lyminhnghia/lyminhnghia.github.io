...
<ComponentPreview
  ...
  openInV0Url="https://lyminhnghia.github.io/r/github-stars.json"
/>
...
```bash
npx shadcn@latest add @lyminhnghia/github-stars
```
...
```tsx
<GithubStars repo="lyminhnghia/lyminhnghia.github.io" stargazersCount={0} />
```
