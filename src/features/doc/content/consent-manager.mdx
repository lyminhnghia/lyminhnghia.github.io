...
<Callout>
  @TODO: Embed a screen recording, Storybook, or your own demo URL for the
  consent banner when you have one hosted.
</Callout>
...
```bash
npx shadcn@latest add @lyminhnghia/consent-manager
```
