...
The application should now be available at http://lyminhnghia.localhost:1355 (or your configured dev host)
...
If you're working on a different React project and want to reuse the custom components from this repository, visit [lyminhnghia.github.io/components](https://lyminhnghia.github.io/components) for installation instructions and component documentation.
